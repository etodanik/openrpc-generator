...
export abstract class OpenRPCVisitor {
  ...
  visitExternalDocs(_externalDocs: ExternalDocumentationObject): Voidable<RenderMap> {}
  ...
  visitMethodParam(_method: MethodObject, _param: ContentDescriptorObject): Voidable<RenderMap> {}
  visitMethodResult(_method: MethodObject, _result: ContentDescriptorObject): Voidable<RenderMap> {}
  visitMethodError(_method: MethodObject, _error: ContentDescriptorObject): Voidable<RenderMap> {}
